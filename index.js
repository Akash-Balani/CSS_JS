...
const weatherInfoToday = $("#weather-info-today");
...
const renderCurrentData = (data) => {
	const currentWeatherCard = `<div class="p-3 jumbotron forecast-cards-bg">
    ...
    <div class="mt-4">
      ...
      <div class="row g-0">
        ...
        <div class="col-sm-12 col-md-8 p-2 border">
          <span class="text-black px-3 rounded-2 ${getUviClassName(
	...
	weatherInfoToday.append(currentWeatherCard);
};
...
const renderForecastData = (data) => {
	const createForecastCard = (each) => {
      ...
      <div class="card-body">
        <h5 class="card-title text-center text-black">${moment
					.unix(each.dt)
        ...
        <div class="mt-4 text-center">
          <div class="row g-0">
            ...
            <div class="col-12 p-2 border text-black">${
							each.temp.day
						}&deg; C</div>
          </div>
          <div class="row g-0">
...
const renderErrorAlert = () => {
	...
	weatherInfoToday.empty();
	const alert = `<div class="alert alert-danger" role="alert">
    Something went wrong!! Please try again.
  </div>`;

	weatherInfoContainer.append(alert);
	weatherInfoToday.append(alert);
};
